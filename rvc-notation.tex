...
\newcommand{\estpose}[1][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{}{\presup{#1}}{\mathbf{\hat{\xi}}}}
...
\renewcommand{\vec}[2][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{}{\presup{#1}}{\bm{\mathit{#2}}}}
...
\newcommand{\mat}[2][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{}{\presup{#1}\,}{{\boldsymbol #2}}}
\newcommand{\dmat}[2][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{}{\presup{#1}\,}{{\dot{\boldsymbol #2}}}}
\newcommand{\emat}[2][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{}{\presup{#1}\,}{\hat{\boldsymbol#2}}}
...
\newcommand{\point}[2][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{}{\presup{#1}}{\mathbf{\mathrm{#2}}}}
