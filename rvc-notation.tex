...
\newcommand{\posedot}[1][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{}{\presup{#1}}{\mathbf{\nu}}}
...
\newcommand{\duquat}[2][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{}{\presup{#1}}{\dot{\mathring{#2}}}}
\newcommand{\quat}[2][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{}{\presup{#1}}{\breve{#2}}}

\DeclareMathAlphabet{\mathitbf}{OML}{cmm}{b}{it}
\newcommand{\twist}[2][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{}{\presup{#1}}{\mathcal{S}}}
...
%\newcommand{\vech}[2][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{}{\presup{#1}}{\mathitbf{\tilde{#2}}}
%\newcommand{\vecb}[2][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{}{\presup{#1}}{\bar{\mathitbf{#2}}}
...
\newcommand{\matfn}[3][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{}{\presup{#1}}{{\mat{#2}}\left(#3\right)}}
\newcommand{\Rt}[2][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{}{\presup{#1}}{{\bf R}\left(#2\right)}}


%\newcommand{\homt}[3]{{}^{#1}{\bf #3}_{#2}}
%\renewcommand{\frame}[2]{{}^{#1}{#2}}

\newcommand{\cframe}[1]{\ensuremath{\{\mathrm{#1}\}}}
\newcommand{\cspace}{{\cal C}}
\newcommand{\point}[2][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{}{\ensuremath{\presup{#1}}}{\ensuremath{\mathrm{#2}}}}

%{\ensuremath{\presup{#1}{\mathbf{\mathrm{#2}}}}}
...
%\fvset{formatcom=\color{blue},fontseries=c,fontfamily=menlo,xleftmargin=4mm,commentchar=!}
%
%\DefineVerbatimEnvironment{Code}{Verbatim}{formatcom=\color{blue},fontseries=c,fontfamily=menlo,fontsize=\footnotesize,xleftmargin=4mm,commentchar=!}

\fvset{formatcom={\color{blue}\baselineskip=-\maxdimen\lineskip=0pt},xleftmargin=4mm,commentchar=!}

\DefineVerbatimEnvironment{Code}{Verbatim}{}

\DefineVerbatimEnvironment{CodeSmall}{Verbatim}{fontsize=\scriptsize,xleftmargin=1mm,commentchar=!}

\DefineVerbatimEnvironment{CodeNum}{Verbatim}{numbers=left,numbersep=4pt,fontsize=\footnotesize,xleftmargin=4mm}
...
\newcommand{\func}[2][_NONE]{\ifthenelse{\equal{#1}{_NONE}}{\index{code}{#2}}{\index{code}{#1}}\ifthenelse{\boolean{draft}}{{\color{green}\Verb+#2+}}{\Verb+#2+}}
...
\newcommand{\obs}[1]{#1^{\scalebox{0.6}{\#}}}
\usepackage{xparse}

\NewDocumentCommand{\ovec}{ o m o }{%
  \IfValueT{#1}{\presup{#1}}%
  \vec{#2}%
  \IfValueT{#3}{_{#3}}
  ^{\scalebox{0.6}{\#}}%
  }
\NewDocumentCommand{\omat}{ o m o }{%
  \IfValueT{#1}{\presup{#1}}%
  \mat{#2}%
  \IfValueT{#3}{_{#3}}
  ^{\scalebox{0.6}{\#}}%
...
\NewDocumentCommand{\obspose}{ o o }{%
  \IfValueT{#1}{\presup{#1}}%
  \mathbf{\xi}%
  \IfValueT{#2}{_{#2}}
  ^{\scalebox{0.6}{\#}}%
...
\newcommand{\UC}{\mathrm{S}}
\newcommand{\TStwo}{\mathbb{R}^2 \times \UC^1}
\newcommand{\TSthree}{\mathbb{R}^3 \times \UC^3}
